...
A simple python script that converts basic Nori scenes to Mitsuba scenes (XML to XML). The converter is very basic and only supports a limited set of features, but can be very useful for quick comparisons.
